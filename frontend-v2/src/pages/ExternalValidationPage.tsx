...
export function ExternalValidationPage() {
  ...
  const model = ['custom_random_forest', 'sklearn_random_forest'].includes(state.model) ? state.model : 'custom_random_forest'
